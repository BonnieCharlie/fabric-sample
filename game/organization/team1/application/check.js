 ...
 * 4. Construct request to check a specific update
...
const PlayerUpdate = require('../../team2/contract/lib/playerupdate.js');
...
async function main () {
    ...
    try {
        ...
        const checkResponse = await contract.submitTransaction('check', 'Bob', '00001', 'f14dws35c', '2020-01-28');
        ...
        console.log(`Check of ${playerUpdate.issuer} player update : ${playerUpdate.updateNumber} successfully checked.`);
